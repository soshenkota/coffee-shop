(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".testimonial-page__slider")) new swiper_core_Swiper(".testimonial-page__slider", {
                ...
                navigation: {
                    prevEl: ".buttons__arrow.buttons__left",
                    nextEl: ".buttons__arrow.buttons__right"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        da.init();
        const boxs = document.querySelectorAll(".product-page__box");
        boxs.forEach((box => {
            box.addEventListener("click", boxClass);
            function boxClass(e) {
        ...
        function addToCart() {
            const afters = document.querySelectorAll(".product-page__after");
            afters.forEach((after => {
                if (after.closest(".new")) after.style.cssText = `\n            left: 0;\n             opacity: 1;\n            `;
            }));
        }
        window["FLS"] = false;
        isWebp();
